...
import { ArrowRight, CheckCircle2, CreditCard, ShieldCheck, Zap, LayoutDashboard, LogOut } from "lucide-react"
import { supabase } from "@/lib/supabase"
import { useEffect, useState } from "react"
import { User } from "@supabase/supabase-js"
// import { Logo } from "@/components/logo" // Descomenta esto si usas el componente Logo
    ...
    return (
        <div className="min-h-screen bg-white selection:bg-blue-100 font-sans relative overflow-hidden">
                        ...
                        {!loading && (
                            user ? (
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <Link href="/dashboard">
                                        <Button className="bg-slate-900 text-white hover:bg-slate-800 rounded-full px-6 shadow-lg shadow-slate-900/20 transition-all hover:scale-105">
            ...
            <main className="flex flex-col items-center">
                ...
                {/* --- HERO SECTION --- */}
                <section className="w-full pt-24 pb-32 text-center px-6 max-w-4xl mx-auto space-y-8 relative z-10">
                    <div className="inline-flex items-center rounded-full border border-blue-200 bg-blue-50/50 px-3 py-1 text-sm font-medium text-blue-700 mb-4 backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        ...
                        {!loading && user ? (
                            <Link href="/dashboard">
                                <Button size="lg" className="h-14 px-8 text-lg bg-emerald-600 hover:bg-emerald-700 text-white rounded-full shadow-xl shadow-emerald-900/10 hover:shadow-emerald-900/20 transition-all hover:-translate-y-1">
                            ...
                            <Link href="/login">
                                <Button size="lg" className="h-14 px-8 text-lg bg-slate-900 hover:bg-slate-800 rounded-full shadow-xl shadow-blue-900/10 hover:shadow-blue-900/20 transition-all hover:-translate-y-1">
                                    Crear cuenta gratis
                ...
                {/* --- VISUAL DEMO --- */}
                <section className="w-full max-w-6xl px-6 mb-32 relative group perspective-1000">
                    ...
                    <div className="relative rounded-2xl border border-slate-200/60 bg-white/50 p-2 shadow-2xl backdrop-blur-sm transition-transform duration-700 hover:scale-[1.01]">
                        <div className="rounded-xl border border-slate-200 bg-slate-50 overflow-hidden aspect-[16/9] flex items-center justify-center relative">
                            <div className="text-center space-y-2">
                                ...
                                <p className="text-slate-400 font-medium">Captura del Dashboard</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                {/* --- FEATURES --- */}
                <section className="w-full max-w-6xl px-6 py-24 border-t border-slate-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Feature 1 */}
                        <div className="p-8 rounded-3xl border border-slate-100 bg-white shadow-lg shadow-slate-200/50 hover:shadow-xl transition-all hover:-translate-y-1">
                            ...
                            <p className="text-slate-500 leading-relaxed">Recibe un correo 3 días antes de que Netflix te cobre. No más sorpresas en el banco.</p>
                        </div>
                        {/* Feature 2 */}
                        <div className="p-8 rounded-3xl border border-slate-100 bg-white shadow-lg shadow-slate-200/50 hover:shadow-xl transition-all hover:-translate-y-1">
                            ...
                            <p className="text-slate-500 leading-relaxed">Sabemos exactamente cuánto gastas al año. Convertimos pagos anuales a mensuales automáticamente.</p>
                        </div>
                        {/* Feature 3 */}
                        <div className="p-8 rounded-3xl border border-slate-100 bg-white shadow-lg shadow-slate-200/50 hover:shadow-xl transition-all hover:-translate-y-1">
                            ...
                            <p className="text-slate-500 leading-relaxed">Tus datos son tuyos. No vendemos tu información a bancos ni a terceros.</p>
                        </div>
                    </div>
                </section>

                <footer className="w-full py-12 border-t border-slate-100 mt-12 bg-slate-50">
